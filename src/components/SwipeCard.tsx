          ...
          <div className="min-h-full pb-48">
            ...
            <div className="relative w-full aspect-[3/4] max-h-[55vh]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 pt-12 bg-gradient-to-t from-black to-transparent">
                {location && (
                  <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-black/20 border border-white/10 backdrop-blur-md text-zinc-300 text-sm mb-2 font-inter font-semibold uppercase">
              ...
              {founderProfile?.stage && (
                <div className="absolute top-4 right-4">
                  <Badge className="bg-black/20 backdrop-blur-md text-white border border-white/10 px-3 py-1 text-xs tracking-wider uppercase font-inter font-semibold">
            ...
            <div className="relative w-full aspect-[3/4] max-h-[55vh]">
              ...
              {investorProfile.preferred_stage && (
                <div className="absolute top-4 left-4">
                  <Badge className="bg-black/20 backdrop-blur-md text-white border border-white/10 px-3 py-1 rounded-full text-xs tracking-wider uppercase font-inter font-semibold">
