      ...
      >
        ...
        {!isAdProfile && profileId && (
          <button
            ...
            className="absolute top-[160px] right-4 z-20 p-2.5 bg-black/40 backdrop-blur-sm rounded-full border border-white/10 transition-all hover:bg-black/60 active:scale-95"
          >
            {shareCopied ? (
            ...
            <div className="relative w-full aspect-[3/4] max-h-[55vh]">
              ...
              {investorProfile.preferred_stage && (
                <div className="absolute top-4 left-4">
                  <Badge className="bg-transparent text-white border border-white/10 px-3 py-1 rounded-full text-xs tracking-wider uppercase font-inter font-semibold">
